...
export default function ComicHomePage() {
  ...
  return (
    <div style={{ background: '#060606', minHeight: '100vh' }}>
      ...
      {/* ══════ MANIFEST — Full-width background section ══════ */}
      <section
        className="manifest-section relative flex items-center justify-center"
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 sm:px-10 py-20 sm:py-24">
      ...
      <style>{`
        ...
        .perf-card:hover .perf-bg { animation: gear-move 12s linear infinite; }
        ...
        @keyframes speed-dash { 0% { left: -40%; opacity: 0; } 30% { opacity: 1; } 100% { left: 120%; opacity: 0; } }
        ...
        /* Manifest parallax fallback for mobile */
        @media (max-width: 768px) {
          .manifest-section > div:first-child {
